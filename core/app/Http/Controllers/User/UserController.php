...
class UserController extends Controller
{
    public function home()
    {
        ...
        return view($this->activeTemplate . 'user.dashboard', $data, compact('pageTitle', 'widget', 'coins'));
    }
    ...
    public function CryptoTrade(Request $request)
    {
        ...
        return view($this->activeTemplate . 'user.assets.crypto.index', compact('pageTitle'));
    }
