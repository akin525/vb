...
{ 
    ...
    public function storefront($id)
    {
        ...
        return view($this->activeTemplate.'user.vendor.storefront.front_storefront', compact('pageTitle', 'storefront','products'));
    }  
    ...
    public function product($id)
    {
        ...
        return view($this->activeTemplate . 'user.vendor.storefront.front_product', compact('pageTitle', 'product', 'storefront','orders'));
    } 
