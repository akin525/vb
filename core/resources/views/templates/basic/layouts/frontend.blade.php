...
<head>
    ...
    <link href="{{ asset($activeTemplateTrue . 'css/styles.css')}}" rel="stylesheet">
    <link href="{{ asset('assets/thirdparty/css/cookie.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset($activeTemplateTrue . 'css/style.php') }}?color={{substr($general->base_color, 1)}}&secondColor={{substr($general->secondary_color, 1)}}" rel="stylesheet">
...
<body>
    ...
    @endif
		...
		<script src="{{ asset($activeTemplateTrue . 'js/bootstrap-select.min.js')}}"></script>
		<script src="{{ asset($activeTemplateTrue . 'js/rangeslider.js')}}"></script>
		<script src="{{ asset($activeTemplateTrue . 'js/slick.js')}}"></script>
		<script src="{{ asset($activeTemplateTrue . 'js/counterup.min.js')}}"></script>
		...
		<script src="{{ asset($activeTemplateTrue . 'js/shuffle.min.js')}}"></script>
		<script src="{{ asset($activeTemplateTrue . 'js/wow.js')}}"></script>
		<script src="{{ asset($activeTemplateTrue . 'js/lunar.js')}}"></script>
