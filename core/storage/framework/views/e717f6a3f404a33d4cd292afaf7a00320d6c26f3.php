                    ...
                    <form class="form w-100 verify-gcaptcha" novalidate="novalidate" method="POST"
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <input type="text" name="username" value="<?php echo e(old('username')); ?>" required
                                placeholder="<?php echo app('translator')->get('Enter Username'); ?>" autocomplete="off" class="form-control bg-transparent" />
                            <!--end::Username-->
                        </div>
                        ...
                        <div class="fv-row mb-8 ">
                            <!--begin::Country-->
                            <select name="country" class="form-select form-control select2 bg-transaparent"
...
<?php echo $__env->make($activeTemplate . 'layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/billxgiftbills/public_html/core/resources/views/templates/basic/user/auth/register.blade.php ENDPATH**/ ?>