                          ...
                          <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                           <label class='badge text-white  <?php if($deposit->status_code == 1 || $deposit->status_code == 3): ?> bg-success <?php else: ?> bg-warning <?php endif; ?>'> <?php echo $deposit->status ?></label>
                                      ...
                                      >
                                        <div class="modal-body p-4">
                                          <div class="text-center text-success">
                                            ...
                                            <a href="<?php echo e(route('admin.crypto.assetselltrade.decline',$deposit->trx)); ?>" class="btn btn-success my-2">
                                              Continue
                                            </a>
                                          </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vb\core\resources\views/admin/currency/sell_log.blade.php ENDPATH**/ ?>