                          ...
                          <div class="modal-body pb-5 px-sm-5 pt-50">
                              ...
                              <form role="form" method="POST" class="row gy-1 pt-75"
                                  ...
                                  <div class="col-12 mb-4">
                                      ...
                                      <input type="file"class="form-control" placeholder="Currency" value="<?php echo e($giftcard->image); ?>"
                                      name="photo">
                                  </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/billxgiftbills/public_html/core/resources/views/admin/giftcard/edit.blade.php ENDPATH**/ ?>