...
?>
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-xl-4 col-lg-5 col-md-5">
								<p class="mb-0"><script>document.write(new Date().getFullYear())</script>© <?php echo e($general->site_name); ?>® Design by <?php echo app('translator')->get('TECH PLUS'); ?>.</p>
							</div>
 ...
 <?php /**PATH /home/billxgiftbills/public_html/core/resources/views/templates/basic/partials/footer.blade.php ENDPATH**/ ?>