                                            ...
                                            <script>
                                                function networkprovider(operatorId,image,name,networkid) { 
                                                          ...
                                                          document.getElementById("networkid").value = networkid;
                                                                  ...
                                                                  fetch("<?php echo e(route('user.internet_sme.operatorsInternetdetailsGSUBZ')); ?>", requestOptions)
                                        ...
                                        function() {
                                            ...
                                            function submitform()
                                            {
                                              ...
                                              var raw = JSON.stringify({
                                                ...
                                                fetch("<?php echo e(route('user.buy.internet_sme_gsubz')); ?>", requestOptions)
                                                  .then(response => response.text())
                                                  .then(result => 
                                                  {
                                                    resp = JSON.parse(result);
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vb\core\resources\views/templates/basic/user/bills/internetsme/internet_buy_GSUBZ.blade.php ENDPATH**/ ?>