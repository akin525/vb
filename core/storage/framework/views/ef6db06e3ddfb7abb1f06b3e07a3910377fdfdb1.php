            ...
            <div class="card-body ">
                <div class="row ">
                    ...
                    <div class="col-4 col-sm-3 col-lg-3">
                        <a href="<?php echo e(url('user/internet/sme')); ?>">
                            <div class="card">
                    ...
                    <div class="col-4 col-sm-3 col-lg-3">
                        <a href="<?php echo e(url('user/airtime')); ?>">
                            <div class="card">
                                <div class="card-body p-3 text-center">
                             <span style="font-size: 30px;">
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vb\core\resources\views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>