        ...
        <?php endif; ?>
          ...
          <li class="sidebar-item">
              <a class="sidebar-link" href="<?php echo e(route('user.crypto.trade.index')); ?>" aria-expanded="false">
                ...
                <span class="hide-menu"><?php echo app('translator')->get('Trade Crypto'); ?></span>
              </a>
          </li>
          <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\vb\core\resources\views/templates/basic/partials/sidenav.blade.php ENDPATH**/ ?>